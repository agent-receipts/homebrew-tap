...
class AgentReceiptsHook < Formula
  desc "Hook that forwards agent tool-call events to the agent-receipts daemon"
  ...
  conflicts_with "agent-receipts-hook-alpha", because: "both install the same binaries"
